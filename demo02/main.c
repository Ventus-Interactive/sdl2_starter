...
int main(void)
{
    ...
    printf(
        "sdl2:RenderTarget.supported=%s", 
        (SDL_RenderTargetSupported(rend) == SDL_TRUE ? "Yes" : "No")
    );
    
#define newSurface(id, what) SDL_Surface* id; \
if (!(id = IMG_Load("resources/" what)))
    ...
    //SDL_Surface* surface;
    //if (!(surface = IMG_Load("resources/hello.png")))
    newSurface(surface, "hello.png") {
